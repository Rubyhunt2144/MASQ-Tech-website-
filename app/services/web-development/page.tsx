import { CheckCircle, Code, Globe, Palette, ArrowRight } from "lucide-react"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <ScrollAnimatedSection>
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                Website <span className="gradient-text">Development & Design</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Create stunning, responsive websites that captivate your audience and drive business growth with modern
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimatedSection className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Complete Web Solutions</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From design to development, we create websites that work beautifully across all devices
            </p>
          </ScrollAnimatedSection>
            ...
            {[
              {
                ...
                features: ["Custom Design", "User Research", "Wireframing", "Prototyping"],
              },
              {
                icon: <Code className="h-8 w-8" />,
                title: "Frontend Development",
                description: "Modern, responsive websites built with the latest technologies and best practices.",
                features: ["React/Next.js", "Responsive Design", "Fast Loading", "SEO Optimized"],
              },
              {
                icon: <Globe className="h-8 w-8" />,
                title: "Full-Stack Development",
                description: "Complete web applications with robust backend systems and database integration.",
