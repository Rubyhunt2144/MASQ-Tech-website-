import { CheckCircle, BarChart3, Database, TrendingUp, ArrowRight } from "lucide-react"
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <ScrollAnimatedSection>
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                Data <span className="gradient-text">Analyst</span> Services
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Transform your business data into actionable insights. We provide comprehensive data analysis,
                visualization, and reporting to help you make informed decisions and drive growth.
              </p>
              <Button
                asChild
                size="lg"
              ...
              >
                <Link href="/contact">Get Data Insights</Link>
              </Button>
            </ScrollAnimatedSection>
            ...
            <ScrollAnimatedSection>
              <div className="relative">
                <div className="aspect-square bg-gradient-to-br from-cyan-100 to-green-100 rounded-3xl flex items-center justify-center relative overflow-hidden">
                  ...
                  <BarChart3 className="h-32 w-32 text-cyan-600" />
                </div>
              </div>
            </ScrollAnimatedSection>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollAnimatedSection className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Our Data Analysis Services</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Unlock the power of your data with our comprehensive analysis and visualization services
            </p>
          </ScrollAnimatedSection>
            ...
            {[
              {
                ...
                description:
                  "Create compelling charts, graphs, and dashboards that make complex data easy to understand.",
                features: ["Interactive Dashboards", "Custom Charts", "Real-time Updates", "Mobile Responsive"],
              },
              {
                icon: <Database className="h-8 w-8" />,
                title: "Statistical Analysis",
                description: "Advanced statistical methods to uncover patterns, trends, and insights in your data.",
                features: ["Predictive Modeling", "Trend Analysis", "Correlation Studies", "Hypothesis Testing"],
              },
              {
                icon: <TrendingUp className="h-8 w-8" />,
                title: "Business Intelligence",
                description: "Transform raw data into strategic business insights for better decision making.",
                features: ["KPI Tracking", "Performance Metrics", "Market Analysis", "Competitive Intelligence"],
              },
            ].map((service, index) => (
